#
#  Be sure to run `pod spec lint LEPhotoCollectionView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = "Leave"
  # s.authors            = { "Leave" => "email@address.com" }
  ...
  s.source       = { :git => "https://github.com/leavez/LEPhotoCollectionView.git", :tag => "0.0.1" }
